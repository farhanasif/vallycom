<template>
    <div class="content" style="min-height: 1419.6px;">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 col-sm-6">
              ...
              <div class="col-12">
                <img :src="getImage()" class="product-image" alt="Product Image">
              </div>
              <div class="col-12 product-image-thumbs">
                <div class="product-image-thumb active"><img :src="getImage()" alt="Product Image"></div>
                <div class="product-image-thumb"><img :src="getImage()" alt="Product Image"></div>
                <div class="product-image-thumb"><img :src="getImage()" alt="Product Image"></div>
                <div class="product-image-thumb"><img :src="getImage()" alt="Product Image"></div>
                <div class="product-image-thumb"><img :src="getImage()" alt="Product Image"></div>
              </div>
...
<script>
    export default {
        ...
        methods: {
            getImage : function(){
                return "../img/products/vitality-pic.jpg";
            },
        }
    }
</script>